...
```ts
new ItemSingleEquipment(props): ItemSingleEquipment;
```
...
[`ItemEquipment`](ItemEquipment.md).[`constructor`](ItemEquipment.md#constructor)
...
[`ItemEquipment`](ItemEquipment.md).[`isSingleInstance`](ItemEquipment.md#issingleinstance)
...
[`ItemEquipment`](ItemEquipment.md).[`getInventoryId`](ItemEquipment.md#getinventoryid)
...
[`ItemEquipment`](ItemEquipment.md).[`applyModifiers`](ItemEquipment.md#applymodifiers)
...
[`ItemEquipment`](ItemEquipment.md).[`revertModifiers`](ItemEquipment.md#revertmodifiers)
...
[`ItemEquipment`](ItemEquipment.md).[`isType`](ItemEquipment.md#istype)
...
[`ItemEquipment`](ItemEquipment.md).[`fireEvent`](ItemEquipment.md#fireevent)
...
[`ItemEquipment`](ItemEquipment.md).[`listenEvent`](ItemEquipment.md#listenevent)
...
```ts
equip(applyMods?): Promise<false | void>;
```
...
[`ItemEquipment`](ItemEquipment.md).[`equip`](ItemEquipment.md#equip)
...
```ts
unequip(revertMods?): Promise<false | void>;
```
...
[`ItemEquipment`](ItemEquipment.md).[`unequip`](ItemEquipment.md#unequip)
